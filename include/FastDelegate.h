...
namespace _detail {	// we'll hide the implementation _details in a nested namespace.
...
protected: 
	...
	typedef void (_detail::GenericClass::*GenericMemFuncType)(); // arbitrary MFP.
	_detail::GenericClass *m_pthis;
...
//N=0
template<class RetType=_detail::DefaultVoid>
class FastDelegate0 {
private:
	typedef typename _detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	typedef DesiredRetType (*StaticFunctionPtr)();
	typedef RetType (*UnvoidStaticFunctionPtr)();
	typedef RetType (_detail::GenericClass::*GenericMemFn)();
	typedef _detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
...
public:
	...
	FastDelegate0(Y *pthis, DesiredRetType (X::* function_to_bind)() ) {
		m_Closure.bindmemfunc(_detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	FastDelegate0(const Y *pthis, DesiredRetType (X::* function_to_bind)() const) {
		m_Closure.bindconstmemfunc(_detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
...
//N=1
template<class Param1, class RetType=_detail::DefaultVoid>
class FastDelegate1 {
private:
	typedef typename _detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	typedef DesiredRetType (*StaticFunctionPtr)(Param1 p1);
	typedef RetType (*UnvoidStaticFunctionPtr)(Param1 p1);
	typedef RetType (_detail::GenericClass::*GenericMemFn)(Param1 p1);
	typedef _detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
	ClosureType m_Closure;
public:
	// Typedefs to aid generic programming
...
//N=2
template<class Param1, class Param2, class RetType=_detail::DefaultVoid>
class FastDelegate2 {
private:
	typedef typename _detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	typedef DesiredRetType (*StaticFunctionPtr)(Param1 p1, Param2 p2);
	typedef RetType (*UnvoidStaticFunctionPtr)(Param1 p1, Param2 p2);
	typedef RetType (_detail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2);
	typedef _detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
	ClosureType m_Closure;
public:
	// Typedefs to aid generic programming
...
//N=3
template<class Param1, class Param2, class Param3, class RetType=_detail::DefaultVoid>
class FastDelegate3 {
private:
	typedef typename _detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	typedef DesiredRetType (*StaticFunctionPtr)(Param1 p1, Param2 p2, Param3 p3);
	typedef RetType (*UnvoidStaticFunctionPtr)(Param1 p1, Param2 p2, Param3 p3);
	typedef RetType (_detail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3);
	typedef _detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
	ClosureType m_Closure;
public:
	// Typedefs to aid generic programming
...
//N=4
template<class Param1, class Param2, class Param3, class Param4, class RetType=_detail::DefaultVoid>
class FastDelegate4 {
private:
	typedef typename _detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	...
	typedef RetType (_detail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4);
	typedef _detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
	ClosureType m_Closure;
public:
	// Typedefs to aid generic programming
...
//N=5
template<class Param1, class Param2, class Param3, class Param4, class Param5, class RetType=_detail::DefaultVoid>
class FastDelegate5 {
private:
	typedef typename _detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	...
	typedef RetType (_detail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5);
	typedef _detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
	ClosureType m_Closure;
public:
	// Typedefs to aid generic programming
...
//N=6
template<class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class RetType=_detail::DefaultVoid>
class FastDelegate6 {
private:
	typedef typename _detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	...
	typedef RetType (_detail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6);
	typedef _detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
	ClosureType m_Closure;
public:
	// Typedefs to aid generic programming
...
//N=7
template<class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class RetType=_detail::DefaultVoid>
class FastDelegate7 {
private:
	typedef typename _detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	...
	typedef RetType (_detail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7);
	typedef _detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
	ClosureType m_Closure;
public:
	// Typedefs to aid generic programming
...
//N=8
template<class Param1, class Param2, class Param3, class Param4, class Param5, class Param6, class Param7, class Param8, class RetType=_detail::DefaultVoid>
class FastDelegate8 {
private:
	typedef typename _detail::DefaultVoidToVoid<RetType>::type DesiredRetType;
	...
	typedef RetType (_detail::GenericClass::*GenericMemFn)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8);
	typedef _detail::ClosurePtr<GenericMemFn, StaticFunctionPtr, UnvoidStaticFunctionPtr> ClosureType;
	ClosureType m_Closure;
public:
	// Typedefs to aid generic programming
...
#ifdef FASTDLGT_VC6
#define FASTDLGT_RETTYPE _detail::VoidToDefaultVoid<RetType>::type
#else 
